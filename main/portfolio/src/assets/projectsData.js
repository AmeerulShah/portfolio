export const projectsData = [
    ...
    
    {
        ...
        projectDescription:
            'Created a set of around 20 ansible playbooks scripts which aim to automate basic system administration tasks.',
        imageUrl: 'https://i0.wp.com/volumes.blog/wp-content/uploads/2020/06/060120_1607_WhatisDellT1.png?w=760&ssl=1',
        videoUrl:
    ...
    },
    {
        ...
        projectDescription:
            "Explored and implemented cool features using OpenCV such as Real time video capture, Face detection,etc.",
        imageUrl: 'https://drive.google.com/uc?export=view&id=1KSpLIbAS-kdXWtMuJjmLDEoxVqHOqGv9',
        videoUrl:
